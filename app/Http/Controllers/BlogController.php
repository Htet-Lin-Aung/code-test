...
class BlogController extends Controller
{
    ...
    public function store(BlogRequest $request)
    {
        ...
        return redirect()->route('blog.index')->with('success','Blog created successful');
    }
    ...
    {
        $this->blogRepository->updateBlog($request->all(),$blog);
    ...
    {
        $this->blogRepository->destroyBlog($blog);
